...
<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
    ...
    <div class="form-group">
        ...
        <input class="form-control" name="nim" required type="text" placeholder="V3420028" minlength="8" maxlength="8"
            title="Karakter pertama harus huruf kemudian diikuti angka sesuai format NIM!" pattern="^[A-Z]{1}[0-9]{7}">
    </div>
    <!-- Nama -->
    <div class="form-group">
        <label for="nama">Nama Lengkap</label>
        <input class="form-control" name="nama" required type="text" placeholder="Devi Anggita Ambarwati" minlength="3"
            title="Isi sesuai dengan nama Anda. Isian tidak mengandung angka atau simbol!" pattern="(^[a-zA-Z-' ]*$)">
    </div>
    <!-- Kata Sandi -->
    <div class="form-group">
